...
#include <Adafruit_TFTLCD_16bit_GD32.h> // Hardware-specific library
...
Adafruit_TFTLCD_16bit_GD32 tft;
...
void setup(void) {
    ...
    Serial.print((uint16_t) tft.width());
    Serial.print("x");
    Serial.println((uint16_t) tft.height());
