...
// OR BREAKOUT BOARD USAGE.  SEE RELEVANT COMMENTS IN Adafruit_TFTLCD_16bit_GD32.h
...
/*****************************************************************************/
Adafruit_TFTLCD_16bit_GD32::Adafruit_TFTLCD_16bit_GD32(void)
        : Adafruit_GFX(TFTWIDTH, TFTHEIGHT) {
}

/*****************************************************************************/
void Adafruit_TFTLCD_16bit_GD32::begin(uint16_t id) {
    reset();
...
/*****************************************************************************/
void Adafruit_TFTLCD_16bit_GD32::reset(void) {
#ifdef USE_FSMC
    fsmc_lcd_init();
#else
...
/*****************************************************************************/
void Adafruit_TFTLCD_16bit_GD32::setAddrWindow(int16_t x1, int16_t y1, int16_t x2, int16_t y2) {
...
/*****************************************************************************/
void Adafruit_TFTLCD_16bit_GD32::flood(uint16_t color, uint32_t len) {
...
/*****************************************************************************/
void Adafruit_TFTLCD_16bit_GD32::drawFastHLine(int16_t x, int16_t y, int16_t length, uint16_t color) {
    int16_t x2;
...
/*****************************************************************************/
void Adafruit_TFTLCD_16bit_GD32::drawFastVLine(int16_t x, int16_t y, int16_t length, uint16_t color) {
    int16_t y2;
...
/*****************************************************************************/
void Adafruit_TFTLCD_16bit_GD32::fillRect(int16_t x1, int16_t y1, int16_t w, int16_t h, uint16_t fillcolor) {
    //Serial.println("\n::fillRect...");
    int16_t x2, y2;
...
/*****************************************************************************/
void Adafruit_TFTLCD_16bit_GD32::fillScreen(uint16_t color) {
    if (driver == ID_932X) {
    ...
    } else if ((driver == ID_9341) || (driver == ID_7575) || (driver == ID_HX8357D) || (driver == ID_NT35310) ||
               (driver == ID_9488)) {
...
/*****************************************************************************/
void Adafruit_TFTLCD_16bit_GD32::drawPixel(int16_t x, int16_t y, uint16_t color) {
    // Clip
    ...
    if ((driver == ID_9341) || (driver == ID_HX8357D) || (driver == ID_NT35310) || (driver == ID_9488)) {
        ...
        writeCommand(0x22); CD_DATA;
        writeData(color); CS_IDLE;
...
/*****************************************************************************/
void Adafruit_TFTLCD_16bit_GD32::drawRGBBitmap(int16_t x, int16_t y, int16_t w, int16_t h, const uint16_t *bitmap) {
...
/*****************************************************************************/
void Adafruit_TFTLCD_16bit_GD32::pushColors(uint16_t *data, int16_t len, bool first) {
    CS_ACTIVE_CD_COMMAND;
...
/*****************************************************************************/
void Adafruit_TFTLCD_16bit_GD32::invertDisplay(bool i) {
    if (driver == ID_932X) {
...
// 								R0=R5											B0=B5
/*****************************************************************************/
uint16_t Adafruit_TFTLCD_16bit_GD32::color565(uint8_t r, uint8_t g, uint8_t b) {
    return ((r & 0xF8) << 8) | ((g & 0xFC) << 3) | (b >> 3);
    //return ((r & 0x1F) << 11) | ((g & 0x3F) << 5) | (b & 0x1F);
}

/*****************************************************************************/
void Adafruit_TFTLCD_16bit_GD32::setRotation(uint8_t x) {
...
/*****************************************************************************/
uint16_t Adafruit_TFTLCD_16bit_GD32::readPixel(int16_t x, int16_t y)
{
...
/*****************************************************************************/
uint16_t Adafruit_TFTLCD_16bit_GD32::readID(void) {
    /*
